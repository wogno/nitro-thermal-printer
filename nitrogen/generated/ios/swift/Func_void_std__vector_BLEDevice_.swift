...
/**
 * Wraps a Swift `(_ value: [BLEDevice]) -> Void` as a class.
...
public final class Func_void_std__vector_BLEDevice_ {
  ...
  private let closure: (_ value: [BLEDevice]) -> Void

  public init(_ closure: @escaping (_ value: [BLEDevice]) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(value: bridge.std__vector_BLEDevice_) -> Void {
