...
exports.normalizePrintBulkItem = normalizePrintBulkItem;
 ...
 */
function normalizePrintBulkItem(item) {
  // Validate type
  ...
  if (item.imageOptions !== undefined && item.imageOptions !== null) {
    normalized.imageOptions = {
      ...
      printerWidthType: item.imageOptions.printerWidthType ?? _types.PrinterWidthType.MM_80,
